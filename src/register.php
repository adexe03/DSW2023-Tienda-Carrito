...
if (isset($_POST['username'], $_POST['email'], $_POST['password'], $_POST['password2'])) {
    ...
    $message = "<p><a href=\"http://localhost/DSW2023-Tienda-Carrito/src/validate.php?email=$email&user_number=$userNum\">pincha aquí para validarte</a></p>";
